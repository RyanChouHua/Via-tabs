...
- 当前开发版本：`0.5.9-sh-only`
- `versionCode`：`54`
- 本轮功能：长按 `解析数据库` 设置解析范围；主页不再提供全局导出；备份管理导出时可设置书签文件夹名。
- 0.5.9 变更：备份导出优先使用备份备注作为书签文件夹名，导出成功后写回备注；新增“文件名也使用书签文件夹名”开关。
...
- 书签导出只从备份管理入口执行，导出前可设置书签根文件夹名。
- 备份备注可作为导出书签文件夹名的默认值，导出后同步为最新名称。
